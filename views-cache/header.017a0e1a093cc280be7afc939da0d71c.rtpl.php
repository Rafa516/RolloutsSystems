...
<body>
  ...
  <div class="mobile_nav">
    ...
    <a href="/admin/todos-rollouts-bsb"><i class="fas fa-th-list"></i><span>
        Rollouts</span></a>
    <?php } ?>

    <?php if( $usuario["localidade"] =='Brasília' ){ ?>
      <a href="/admin/todos-termos-bsb"><i class="fas fa-tasks"></i><span>
          Termos</span></a>
      <?php } ?>


    <?php if( $usuario["localidade"] =='Brasília' ){ ?>
    <a href="/admin/estoque-bsb"><i class="fa fa-table" ></i><span>
        Estoque </span></a>
    <?php } ?>


       <?php if( $usuario["localidade"] =='Brasília' ){ ?>
        <a href="/admin/todos-documentos-bsb"><i class="fas fa-file" ></i><span>
        Documentos </span></a>
        <?php } ?>
  ...
  <div class="sidebar">
   ...
   <?php if( $usuario["localidade"] =='Brasília' ){ ?>
    ...
    <?php if( $usuario["localidade"] =='Brasília' ){ ?>
     ...
     <?php if( $usuario["localidade"] =='Brasília' ){ ?>
      <a href="/admin/termos-antigos-bsb"><i class="fa fa-archive"></i><span>
          Termos antigos</span></a>
      <?php } ?>
