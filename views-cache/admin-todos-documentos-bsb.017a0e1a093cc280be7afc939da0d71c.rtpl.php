  ...
  <div class="content-inside">
    <div class="my-4">
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        ...
        <a style="width: 20%;" href="/admin/registrar-documentos-bsb"class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i><b> Registrar documento</b></a>
        <?php } ?>

         <?php if( totalDocumentosBsb() != 0 ){ ?>
      <div class="search" style="float: right">
        <form action="/admin/todos-documentos-bsb" method="get">
        ...
        <table class=" table table-hover table-sm  table-bordered">
          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
               <center> <a style="width: 100%;" href="/admin/todos-documentos-bsb/arquivos/<?php echo $value1["id_documento"]; ?>"
               ...
               <td>
                  <center> <a style="width: 100%;" href="/admin/documento/editar-bsb/<?php echo $value1["id_documento"]; ?>"
                    class="btn btn-success btn-sm"><i class="fas fa-pen"></i><b> Alterar</b></a></center>
              </td>
               <td>
                  <center><a style="width: 100%;" href="/admin/documentos-bsb/delete/<?php echo $value1["id_documento"]; ?>"
