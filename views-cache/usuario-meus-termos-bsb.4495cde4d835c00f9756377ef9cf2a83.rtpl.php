        ...
        <table class="table table-hover table-sm   table-bordered">
          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
                <center> 
                  <?php if( $value1["termo"] == 'Entrega' ){ ?>
                  <a style="width: 100%;" href="/usuario/termo-entrega/editar-bsb/<?php echo $value1["id_termos"]; ?>"
                    class="btn btn-success btn-sm"><i class="fas fa-pen"></i><b> Alterar</b></a></center>
                  <?php }else{ ?>
                  <a style="width: 100%;" href="/usuario/termo-devolucao/editar-bsb/<?php echo $value1["id_termos"]; ?>"
                  class="btn btn-success btn-sm"><i class="fas fa-pen"></i><b> Alterar</b></a></center>
                  <?php } ?>
              </td>
              <td>
