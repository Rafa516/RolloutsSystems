    ...
    <div class="my-4">
      ...
      <div class="container-fluid px-1 py-5 mx-auto">
        ...
        <form class="form-group" action="/usuario/registrar-termos-bsb/enviar" method="post">
          ...
          <input class="form-control py-1" value="Devolução" name="termo" type="hidden">
          ...
          <div id="formulario_eqp">
            <div class="form-group">
              <label>Equipamento </label> <select class="js-example-basic-single" name="id_equipamento[]"
                style="width: 55%">
                <option value=""></option>
              ...
              &emsp;<label>Quantidade <input name="qtd_entrada[]" style="width: 20%" type="number">

            </div>

          </div>
          <button class="btn btn-primary btn " type="button" onclick="adicionarCampo_eqp()"><i class="fa fa-plus-circle"
          ...
          <div id="formulario_acs">
            <div class="form-group">
              ...
              <label>Acessório </label> <select class="js-example-basic-single" name="id_equipamento[]"
                style="width: 55%">
                <option value=""></option>
          ...
          <button class="btn btn-primary btn " type="button" onclick="adicionarCampo_acs()"><i class="fa fa-plus-circle"
              aria-hidden="true"></i> Adicionar</button>
          <hr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> <select style="width: 100%" class="form-select py-1" name="finalidade" required>
                      ...
                      <option value="Empréstimo longa duração">Devolução</option>
                      <option value="Empréstimo curta duração">Movimentação de material</option>
