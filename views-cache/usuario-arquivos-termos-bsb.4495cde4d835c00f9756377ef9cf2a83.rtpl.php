          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
               ...
               <td>
                <center><a style="width: 100%;" href="/usuario/termos-bsb/<?php echo $value1["id_termos"]; ?>/delete/<?php echo $value1["id_arquivoT"]; ?>"
                    onclick="return confirm('Deseja realmente excluir o Arquivo <?php echo $value1["arquivo_termo"]; ?>?')"
