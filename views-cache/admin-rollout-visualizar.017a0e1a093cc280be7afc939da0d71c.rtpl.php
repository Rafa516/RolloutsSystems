<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
  <div class="content-inside">
    <div class="my-4">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-hover table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <center>Dockstation presa com cadeado na mesa do usuário (quando disponibilizada), com senha
                              da informática - <b>PRESENCIAL</b>
                          </td>
                          <td>
                            <center><?php echo $value["conf14"]; ?>
                          </td>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td> <textarea disabled style="height: 110px; color: black" class="form-control py-1"
                              type="text" name="obs_geral"><?php echo $value["obs_geral"]; ?> </textarea></td>
                        </tr>
      ...
      <?php if( $value["id_usuario"] == $usuario["id_usuario"] ){ ?>
      <a href="/admin/rollout/editar/<?php echo $value["id_rollout"]; ?>" class="btn btn-success btn-sm btn-sm"><i
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group" action="/admin/rollout/anexar-arquivo/<?php echo $value["id_rollout"]; ?>" method="post"
