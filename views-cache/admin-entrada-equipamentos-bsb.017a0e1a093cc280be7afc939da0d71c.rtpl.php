  ...
  <div class="content-inside">
    <div class="my-4">
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        <li class="nav-item">
          <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab" data-toggle="tab"
            role="tab" aria-controls="home" aria-selected="false"><b>Entradas - Brasília  - 
               <?php if( totalEntradas()  == 0 ){ ?>
              Nenhuma Registrada
              <?php }elseif( totalEntradas()  == 1 ){ ?>
              <?php echo totalEntradas(); ?>  Registrada
              <?php }else{ ?>
              <?php echo totalEntradas(); ?>  Registradas
              <?php } ?> </b></a>
        </li>
      ...
      <div class="search" style="float: right">
        <form action="/admin/retirada-equipamentos-bsb" method="get">
        ...
        <table class=" table table-hover table-sm  table-bordered">
          <thead class="table table-dark">
            <tr style="font-size: 16px; font-weight: bold; ">
              ...
              <th>
                <center>Quantidade Entrada<b>
              </th>
              
               <th>
                <center>Data da Entrada<b>
              </th>
          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
                <center><a  href="/admin/termo-visualizar-bsb/<?php echo $value1["id_termos"]; ?>"><?php echo $value1["n_chamadoT"]; ?></a>
              </td>
              ...
              <td>
                <center><?php echo $value1["qtd_entrada"]; ?>
              </td>
