    ...
    <div class="my-4">
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        <li class="nav-item">
          <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab" data-toggle="tab"
            role="tab" aria-controls="home" aria-selected="false"><b>Termos - Recife -
              <?php if( totalTermosRec() == 0 ){ ?>
              Nenhum Registrado
              <?php }elseif( totalTermosRec() == 1 ){ ?>
              <?php echo totalTermosRec(); ?> Registrado
              <?php }else{ ?>
              <?php echo totalTermosRec(); ?> Registrados
              <?php } ?> </b></a>
      ...
      <?php if( $usuario["localidade"] =='Recife' ){ ?>   
        <a style="width: 15%;" href="/usuario/registrar-termos-rec"class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i><b> Registrar Termo</b></a>
         ...
         <a style="width: 15%;" href="/usuario/meus-termos-rec"class="btn btn-success btn-sm"><i class="fa fa-server" aria-hidden="true"></i></i><b> Meus Termos</b></a>
    <?php } ?>

      
 <?php if( totalTermosRec() != 0 ){ ?>
      <div class="search" style="float: right">
        <form action="/usuario/todos-termos-rec" method="get">
